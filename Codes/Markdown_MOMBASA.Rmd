...
#MOMBASA
rm(list=ls())
sheet_name <- "mombasa_1likes_min"
data_df <- read_excel("C:/Users/Alex/OneDrive/Desktop/Tale_of_3_cities/Data/tweets_mombasa_2.xlsx", sheet = sheet_name)
...
ggplot(weekly, aes(x = "", y = weekly, fill = weekday)) +
  ...
  theme_void() +
  labs(title = "MOMBASA Total tweets per Weekday") +
...
ggplot(daily, aes(x = Hour, y = daily, fill = Hour)) +
  ...
  labs(x = "Hour", y = "Count", title = "MOMBASA Daily Total tweets  by Hour") +
  theme_minimal() +
...
ggplot(top_10_counts, aes(x = reorder(username, message_counts), y = message_counts)) +
  ...
  ggtitle("MOMBASA Top 10 User Text Counts") +
  theme_minimal() +
...
ggplot(Retweets, aes(x = reorder(username, total_retweets), y = total_retweets)) +
  ...
  ggtitle("MOMBASA Top 10 Users with Most Retweets") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
axis.title = element_text(size = 12, face = "bold"),
plot.title = element_text(size = 14, face = "bold"),
...
ggplot(Likes, aes(x = reorder(username, total_likes), y = total_likes)) +
  ...
  ggtitle("MOMBASA Top 10 Users with Most Likes") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
axis.title = element_text(size = 12, face = "bold"),
plot.title = element_text(size = 14, face = "bold"),
...
# Create a data frame with the top 50 emoticons and 'MOMBASA'
top_emoticons <- c("MOMBASA", names(top_50_emoticons))
...
# Calculate the coordinates to place 'MOMBASA' 
center_x <- (par()$usr[1] + par()$usr[2]) / 2

text(x = center_x, y = 1, labels = "MOMBASA 🤣", col = "black", cex = 2)
