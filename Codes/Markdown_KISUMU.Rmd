...
#KISUMU
rm(list=ls())
sheet_name <- "selected are minimum 2likes"
data_df <- read_excel("C:/Users/Alex/OneDrive/Desktop/Tale_of_3_cities/Data/tweets_kisumu.xlsx", sheet = sheet_name)
...
ggplot(weekly, aes(x = "", y = weekly, fill = weekday)) +
  ...
  theme_void() +
  labs(title = "KISUMU Total tweets per Weekday") +
...
ggplot(daily, aes(x = Hour, y = daily, fill = Hour)) +
  ...
  labs(x = "Hour", y = "Count", title = "KISUMU Daily Total tweets  by Hour") +
  theme_minimal() +
...
ggplot(top_10_counts, aes(x = reorder(username, message_counts), y = message_counts)) +
  ...
  ggtitle("KISUMU Top 10 User Text Counts") +
  theme_minimal() +
...
ggplot(Retweets, aes(x = reorder(username, total_retweets), y = total_retweets)) +
  ...
  ggtitle("KISUMU Top 10 Users with Most Retweets") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
axis.title = element_text(size = 12, face = "bold"),
plot.title = element_text(size = 14, face = "bold"),
...
ggplot(Likes, aes(x = reorder(username, total_likes), y = total_likes)) +
  ...
  ggtitle("KISUMU Top 10 Users with Most Likes") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
axis.title = element_text(size = 12, face = "bold"),
plot.title = element_text(size = 14, face = "bold"),
...
# Create a data frame with the top 50 emoticons and 'KISUMU'
top_emoticons <- c("KISUMU", names(top_50_emoticons))
...
# Calculate the coordinates to place 'KISUMU' 
center_x <- (par()$usr[1] + par()$usr[2]) / 2

text(x = center_x, y = 1, labels = "KISUMU 🤣", col = "black", cex = 2)
